# https://www.youtube.com/watch?v=YK9a8E45X_Y
# https://github.com/indently/image_text_reading/blob/master/main.py

# Install:
# pip install PIL pytesseract
# (macOS) brew install pytesseract(-lang)
